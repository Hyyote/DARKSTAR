...
namespace DARKSTAR
{
    ...
    class Program
    {
        ...
        private static void RunConsoleMode()
        {
            ...
            if (ConfigLoader.MemoryDrainEnabled)
            {
                MemoryDrainer.Configure(
                    ConfigLoader.MemoryDrainEnabled,
                    ConfigLoader.MemoryDrainIntervalMs,
                    ConfigLoader.MemoryDrainTimeoutMs);
                Logger.WriteVerbose("MemoryDrainer enabled", ConsoleColor.Cyan);
            }
            ...
            BackgroundProcessCloser.Configure(
                ConfigLoader.CloseBackgroundProcesses && ConfigLoader.BackgroundProcessNames.Count > 0,
                ConfigLoader.BackgroundProcessNames);
