    ...
    class Program
    {
        ...
        private static void RunConsoleMode()
        {
            ...
            catch (FileNotFoundException ex)
            {
                ...
                MessageBox.Show(
                    $"Configuration file not found:\n{ex.Message}\n\nPlease ensure config\\config.json exists next to the application.",
            ...
            {
                Logger.WriteColored("No processes configured. Add games to config\\config.json", ConsoleColor.Yellow, true);
