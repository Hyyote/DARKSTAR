...
namespace DARKSTAR.Core
{
    ...
    public static class ConfigLoader
    {
        ...
        private static void AddBuiltInDefaults()
        {
            ...
            // System-critical processes — override any user config that tries to demote these.
            // These are handled by SystemProcessOptimizer / DwmOptimizer directly,
            // or must never be touched at all.
            SetSystemConfig("conhost", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("csrss", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("dwm", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("sihost", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("ctfmon", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("dllhost", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("RuntimeBroker", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("taskhostw", priority: 0, affinity: "ALL", disableBoost: false);
            SetSystemConfig("lsass", priority: 0, affinity: "ALL", disableBoost: false);
        }
